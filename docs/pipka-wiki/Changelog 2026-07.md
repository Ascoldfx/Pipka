...
Финальная Gulf-верификация обнаружила два оставшихся false positive:

- COO получил высокий score после того, как эта роль была удалена из target list. Теперь COO/Chief Operating Officer — profile-driven opt-in и без явной цели получает hard reject.
