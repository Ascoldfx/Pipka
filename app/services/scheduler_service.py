...
from app.sources import AdzunaSource, JobSpySource, ArbeitnowSource, RemotiveSource, ArbeitsagenturSource, XingSource, WatchlistSource, BerlinStartupJobsSource
...
async def _background_scan(bot_app, trigger: str = "scheduled"):
    ...
    async with _scan_lock:
        ...
        aggregator = JobAggregator([AdzunaSource(), JobSpySource(), ArbeitnowSource(), RemotiveSource(), ArbeitsagenturSource(), XingSource(), BerlinStartupJobsSource()])
